...
const seed = async () => {
  try {
    ...
    await Testimonial.create([
      {
        name: 'Sarah Johnson', position: 'CEO', company: 'TechCorp Inc.',
      ...
      {
        name: 'Michael Chen', position: 'CTO', company: 'StartupHub',
      ...
      {
        name: 'Emily Rodriguez', position: 'Project Manager', company: 'Digital Agency Co.',
      ...
      {
        name: 'David Kim', position: 'Entrepreneur', company: 'Freelance Client',
    ...
    await Experience.create([
      {
        company: 'Tech Solutions Inc.', role: 'Senior Frontend Developer',
        duration: 'Jan 2023 - Present', location: 'Karachi, Pakistan', type: 'Full-Time',
        responsibilities: [
      ...
      {
        company: 'Digital Agency Co.', role: 'Full Stack Developer',
        duration: 'Jun 2021 - Dec 2022', location: 'Remote', type: 'Full-Time',
        responsibilities: [
    ...
    await Education.create({
      degree: 'BS Computer Science', institution: 'University of Karachi',
      duration: '2018 - 2022', cgpa: '3.7 / 4.0',
